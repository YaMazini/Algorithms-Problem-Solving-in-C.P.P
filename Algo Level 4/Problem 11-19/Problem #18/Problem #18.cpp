...
short DifferenceBetweenDates(stDate Date1, stDate Date2, bool IncludeLastDay = false)
{
	short DaysCounter = 0;
...
int main()
{
	...
	stDate Date;
	cout << " Enter Your Date of Birth 1: \n";
	Date = ReadDate();

	stDate CurrentDate = GetSystemDate();

	cout << "\n Your Age is: " << DifferenceBetweenDates(Date, CurrentDate, true) << " Day (s)." << endl;
